...
1. Read the manifest file:
   /Users/wenkelee/Documents/Claude/Scheduled/slide-updater/courses/RESEARCH_TASKS.md
   This file contains a table of all decks that need weekly research. Each row has:
   - Deck name (e.g., L1, L2, … L13, L14, L15, L16, L17)
   - Path to the .pptx file (relative to the courses/ directory)
   - Path to the research report output (relative to the courses/ directory)
   - Topics to research
2. For EACH deck listed in the manifest, do the following:
   a. Read the current slide content using:
      python -m markitdown "/Users/wenkelee/Documents/Claude/Scheduled/slide-updater/courses/<Path>"
   ...
   c. Write a research report to:
      /Users/wenkelee/Documents/Claude/Scheduled/slide-updater/courses/<Report>
      The report must include:
      - **Date**: today's date
      - **New Findings**: bullet list of the most important developments, each with a 2–3 sentence summary and a source URL
      - **Suggested Slide Updates**: which existing slides should be revised and what to add or change
